...
from EsdeathRobot.hacking_script import PM_START_TEXT
from redis import StrictRedis
...
LOGGER = logging.getLogger("[EsdeathRobot]")
...
if ENV:
    ...
    from EsdeathRobot.config import Development as Config
    TOKEN = Config.TOKEN
...
print("[EsdeathRobot]: Initializing AIOHTTP Session")
aiohttpsession = ClientSession() 

#install arq
print("[EsdeathRobot]: Initializing ARQ Client")
arq = (ARQ_API_URL, ARQ_API_KEY, aiohttpsession)
updater = tg.Updater(TOKEN, workers=WORKERS, use_context=True)
telethn = TelegramClient(MemorySession(), API_ID, API_HASH)
pbot = Client("EsdeathRobotpbot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from EsdeathRobot.modules.helper_funcs.handlers import (CustomCommandHandler,
