...
import random
import EsdeathRobot.modules.sql.users_sql as sql

from EsdeathRobot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          SUPPORT_CHAT, dispatcher, StartTime, telethn, updater, pbot)
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from EsdeathRobot.modules import ALL_MODULES
from EsdeathRobot.modules.helper_funcs.chat_status import is_user_admin
from EsdeathRobot.modules.helper_funcs.misc import paginate_modules
from EsdeathRobot.hacking_script import PM_START_TEXT, PM_START_PIC
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Add General Esdeath To Your Group ➕️",
...
HELP_STRINGS = """
Hey there! Myself [Esdeath](https://telegra.ph/file/9e9e1112a16894e7998cf.jpg).
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("EsdeathRobot.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        first_name = update.effective_user.first_name
        update.effective_message.reply_photo(
                photo=(HELP_IMG), caption= "<b>Am here !!! Uptime :</b>: <code>{}</code>".format(
                uptime
...
def Saber_about_callback(update, context):
    ...
    if query.data == "about_":
        query.message.edit_text(
            text=f"[天気](https://telegra.ph/file/9e9e1112a16894e7998cf.jpg) Hey {escape_markdown(first_name)},"
              f"\n\n ➖➖➖➖➖➖➖➖➖➖➖➖➖"
              f"\n\n General Esdeath  ➣ :-"
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[General Esdeath At Duty!!!](https://telegra.ph/file/060b79fec4a50f48d59ba.jpg)", parse_mode=ParseMode.MARKDOWN,
