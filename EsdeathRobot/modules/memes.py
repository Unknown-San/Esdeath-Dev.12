...
import EsdeathRobot.modules.helper_funcs.fun_strings as fun
from EsdeathRobot import LOGGER, DEV_USERS, dispatcher
from EsdeathRobot.modules.disable import (
...
*Regex based memes:*
`/decide` (disabled rn) can be also used with regex like: `Anya Forger What? <question>: randomly answer "Yes, No" etc.`
Some other regex filters are:
`me too`.

Anya Forger will reply random strings accordingly when these words are used!
