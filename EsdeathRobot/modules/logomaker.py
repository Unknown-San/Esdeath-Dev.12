...
from EsdeathRobot import OWNER_ID
from EsdeathRobot.events import register
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./EsdeathRobot/LOGO_FONT/*")
    ...
    fname = "fallen.png"
    img.save(fname, "png")
    await telethn.send_file(event.chat_id, file=fname, caption = f"Logo Created By @EsdeathRobot")         
    await pesan.delete()
...
__help__ = """
Anya Forger can create some beautiful and attractive logo for your profile pics.
