...
import html
import EsdeathRobot.modules.sql.blacklistusers_sql as sql
from EsdeathRobot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          dispatcher)
from EsdeathRobot.modules.helper_funcs.chat_status import dev_plus
