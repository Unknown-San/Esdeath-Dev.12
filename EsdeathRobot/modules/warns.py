...
from EsdeathRobot import dispatcher  # BAN_STICKER
...
from EsdeathRobot.modules.helper_funcs.chat_status import (
    is_user_admin,
    bot_admin,
    user_admin_no_reply,
    user_admin,
...
from EsdeathRobot.modules.helper_funcs.extraction import (
    extract_text,
...
from EsdeathRobot.modules.helper_funcs.string_handling import split_quotes
from EsdeathRobot.modules.log_channel import loggable
from EsdeathRobot.modules.sql import warns_sql as sql
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "Rules", url="http://t.me/EsdeathRobot?start={}".format(chat.id)
                    )
                ]
            ]
        )
