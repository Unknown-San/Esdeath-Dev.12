...
from EsdeathRobot import dispatcher
from EsdeathRobot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
from EsdeathRobot.modules.redis.afk_redis import start_afk, end_afk, is_user_afk, afk_reason
from EsdeathRobot import REDIS
from EsdeathRobot.modules.users import get_user_id

from EsdeathRobot.modules.helper_funcs.alternate import send_message
from EsdeathRobot.modules.helper_funcs.readable_time import get_readable_time
    ...
    if res:
        ...
        try:
            options = [
                ...
                "You probably were at @Anime_Chat_Folks",
...
AFK_REGEX_HANDLER = MessageHandler(Filters.regex("(?i)brb" , "(?i)ded)", afk)
